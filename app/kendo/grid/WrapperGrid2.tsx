import Sales from '~/data/explore/salesGrid.client';
import SaleSum from '~/data/explore/salesSumGrid.client';
const Fallback = () => {
    return <div>
...
export function WrapperSalesGrid({data}) { 
  return typeof document !== "undefined" ? <Sales sales={data} /> : <Fallback />
}
export function WrapperSalesSummaryGrid({ data }) { 
  return typeof document !== "undefined" ? <SaleSum data={data} /> : <Fallback />
}
