...
import apoi from "~/data/map/logo/APoI.png";
        ...
        <div className="flex items-center justify-between p-2 ">
          <div className="m-2 flex-1">
            <h2 className="text-3xl font-bold leading-7 text-gray-900">
              Chhattisgarh Election Analytics
            </h2>
          </div>
        </div>
      </div>
      <div className="mx-4 my-2 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-lg bg-white shadow-xl shadow-slate-900/10 relative flex flex-1 flex-col p-3 ">
          <img className="flex items-center h-40" src={chha} alt="map" />
        </div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                <div className="p-2 rounded-lg border">
                  <span className="flex justify-center p-1">
                    ...
                    <h3 className="text-sm font-semibold ml-1">18,999,250</h3>
                  </span>
